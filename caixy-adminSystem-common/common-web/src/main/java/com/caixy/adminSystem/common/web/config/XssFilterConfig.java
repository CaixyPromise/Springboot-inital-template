...
import com.caixy.adminSystem.common.web.config.properties.XssProperties;
import com.caixy.adminSystem.common.web.filter.repeat.RepeatableFilter;
import com.caixy.adminSystem.common.web.filter.xss.XssFilter;
...
public class XssFilterConfig
{
    ...
    public FilterRegistrationBean xssFilterRegistration()
    {
        ...
        initParameters.put("excludes", addContextPathToExcludes(xssProperties.getExcludes(), contextPath));
