package com.caixy.adminSystem.business.user.controller;
...
import com.caixy.adminSystem.common.api.user.vo.AddUserVO;
import com.caixy.adminSystem.common.api.user.vo.EncryptAccountVO;
...
public class UserController
{
    ...
    public Result<AboutMeVO> getMe(HttpServletRequest request)
    {
        ...
        return ResultUtils.success(userConvertor.toAboutMeVO(currentUser));
    }
