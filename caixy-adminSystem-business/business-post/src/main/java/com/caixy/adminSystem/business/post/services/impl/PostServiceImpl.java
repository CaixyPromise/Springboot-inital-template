package com.caixy.adminSystem.business.post.services.impl;
...
import com.caixy.adminSystem.business.post.domain.post.mapper.PostMapper;
import com.caixy.adminSystem.business.post.domain.post.vo.PostVO;
import com.caixy.adminSystem.business.post.domain.postfavour.entity.PostFavour;
import com.caixy.adminSystem.business.post.domain.postfavour.mapper.PostFavourMapper;
...
//        return page;
    ...
    public PostVO getPostVO(Post post, HttpServletRequest request)
    {
        ...
        UserVO user = Optional.ofNullable(userFacadeService.findUserById(userId))
                .orElseThrow(() -> new BusinessException(ErrorCode.PARAMS_ERROR, "用户不存在"));
    ...
    public Page<PostVO> getPostVOPage(Page<Post> postPage, HttpServletRequest request)
    {
        ...
        List<UserVO> userByIds = userFacadeService.findUserByIds(userIdSet);
        Map<Long, UserVO> userIdUserListMap = userByIds.stream().collect(Collectors.toMap(UserVO::getId, Function.identity()));
//        LambdaQueryWrapper<User> userLambdaQueryWrapper = new LambdaQueryWrapper<>();
//        userLambdaQueryWrapper.in(User::getId, userIdSet);
//         Map<Long, List<User>> userIdUserListMap = userMapper.selectList(userLambdaQueryWrapper).stream()
