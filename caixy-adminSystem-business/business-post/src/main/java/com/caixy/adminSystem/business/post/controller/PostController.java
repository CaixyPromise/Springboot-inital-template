...
import com.caixy.adminSystem.business.post.domain.post.dto.PostAddRequest;
import com.caixy.adminSystem.business.post.domain.post.dto.PostEditRequest;
import com.caixy.adminSystem.business.post.domain.post.dto.PostQueryRequest;
import com.caixy.adminSystem.business.post.domain.post.dto.PostUpdateRequest;
...
public class PostController
{
    ...
    public Result<Boolean> deletePost(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request)
    {
        ...
        // 仅本人或管理员可删除
        if (!oldPost.getUserId().equals(user.getId()) && !authManager.isAdmin())
        {
