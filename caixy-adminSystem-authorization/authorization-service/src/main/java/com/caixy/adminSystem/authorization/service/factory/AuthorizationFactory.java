package com.caixy.adminSystem.authorization.service.factory;
...
import com.caixy.adminSystem.authorization.service.utils.UserAgentUtils;
...
public interface AuthorizationFactory
{
     ...
     * 登录操作
     */
    LoginUserVO doLogin(UserVO user, HttpServletRequest request);
    ...
    default LoginUserVO getLoginUserVO(UserVO userVO)
    {
        ...
        return AuthUserConvertor.INSTANCE.voToLoginVO(userVO);
    }
