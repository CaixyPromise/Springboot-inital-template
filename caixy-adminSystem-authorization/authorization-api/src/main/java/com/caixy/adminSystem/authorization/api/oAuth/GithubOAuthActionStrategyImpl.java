package com.caixy.adminSystem.authorization.api.oAuth;

import cn.hutool.core.util.RandomUtil;
import com.caixy.adminSystem.authorization.api.config.properties.OAuth2ClientProperties;
import com.caixy.adminSystem.authorization.api.oAuth.annotation.InjectOAuthConfig;
import com.caixy.adminSystem.authorization.api.oAuth.annotation.OAuthTypeTarget;
import com.caixy.adminSystem.authorization.api.oAuth.domain.dto.github.GithubCallbackRequest;
import com.caixy.adminSystem.authorization.api.oAuth.domain.dto.github.GithubCallbackResponse;
...
import com.caixy.adminSystem.authorization.api.oAuth.domain.dto.github.GithubUserProfileDTO;
        ...
        GithubCallbackRequest>
{
    ...
    private UserLoginByOAuthAdapter getUserLoginByOAuthAdapter(GithubUserProfileDTO userProfileDTO)
    {
        ...
        UserVO.UserVOBuilder userBuilder = UserVO.builder();
    ...
    private GithubUserProfileDTO fetchGitHubUserProfile(String accessToken)
    {
        ...
        try
        {
            ...
            {
                // 错误相应
                log.info("Failed to fetch GitHub user profile accessToken: {}, status code: {}",accessToken, response.getStatusLine().getStatusCode());
                throw new BusinessException(ErrorCode.OPERATION_ERROR, "验证失败");
            }
